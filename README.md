...
## Installation instructions para otra persona que instale tu paquete en el futuro, por eso instrucciones e install
...
[GitHub](https://github.com/MontserratElemi/pkgMetagenomica) with:

``` r
BiocManager::install("MontserratElemi/pkgMetagenomica")
```
...
#> 
#>   First Last (2022). pkgMetagenomica: What the Package Does (One Line,
#>   Title Case). R package version 0.99.0.
#>   https://github.com/MontserratElemi/pkgMetagenomica
#> 
...
#>     url = {https://github.com/MontserratElemi/pkgMetagenomica},
#>   }
```
...
## Development tools
  ...
  - The [documentation
    website](http://MontserratElemi.github.io/pkgMetagenomica) is
